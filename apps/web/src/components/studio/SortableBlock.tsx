...
export const SortableBlock: React.FC<Props> = ({ block }) => {
    ...
    return (
        <div
            ...
            className={`group relative mb-2 p-4 rounded-xl border transition-all cursor-pointer focus-visible:outline-2 focus-visible:outline-primary ${isSelected
        ...
        >
            ...
            <div
                ...
                className="absolute -left-8 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 cursor-grab active:cursor-grabbing p-2 focus-visible:opacity-100 focus-visible:outline-2 focus-visible:outline-primary rounded"
            >
